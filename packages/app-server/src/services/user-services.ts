...
/**
 * Извлекат из документа пользователя
 * данные, которые вернутся после успешной авторизации
 * или создания нового документа в базе данных.
 * 
...
/**
 * Генерирует ответ при неудачной попытке 
...
/**
 * Генерирует объект с данными для создания документа
