...
/**
 * Взрывает бомбу. Рассчитывает радиус по каждому направлению и
...
/**
 * Обновляет состояние пламени на карте. Добавляет или удаляет, 
 * в зависимости от переданного коллбэка.
 */
